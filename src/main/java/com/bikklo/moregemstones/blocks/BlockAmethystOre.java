...
public class BlockAmethystOre extends Block {
	...
	{
		super(Material.ROCK);
		setUnlocalizedName(Reference.MoreGemstonesBlocks.BLOCKAMETHYSTORE.getUnlocalizedName());
		setRegistryName(Reference.MoreGemstonesBlocks.BLOCKAMETHYSTORE.getRegistryName());
