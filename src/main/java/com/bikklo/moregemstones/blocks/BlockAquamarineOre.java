...
public class BlockAquamarineOre extends Block {
	...
	{
		super(Material.ROCK);
		setUnlocalizedName(Reference.MoreGemstonesBlocks.BLOCKAQUAMARINEORE.getUnlocalizedName());
		setRegistryName(Reference.MoreGemstonesBlocks.BLOCKAQUAMARINEORE.getRegistryName());
	...
	{
		return ModItems.itemaquamarine;
	}
